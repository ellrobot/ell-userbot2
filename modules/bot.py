...
piic = "https://telegra.ph/file/312623ecfa3eb3979220b.jpg"

buttons = [
    [
        Button.url(get_string("bot_4"), "t.me/ellsupportsistem"),
    ]
]
...
in_alive = "<b>ᴇʟʟ - ʀᴏʙᴏᴛ</b>\n<b>     status :</b> <code>{}</code>{}\n<b>       expired_on :</b> <code>{}</code>\n<b>       dc_id :</b> <code>{}</code>\n<b>       ping_dc :</b> <code>{} ms</code>\n<b>       version :</b> <code>{}</code>\n<b>       nayalibs :</b> <code>{}</code>\n<b>       uptime :</b> <code>{}</code>"

absen = [
    "**Hadir Sayang** 😳",
    "**Hadir Bro ell** 😁",
    "**Maaf ka habis nemenin ka ell** 🥺",
    "**Maaf ka habis disuruh Tuan ell** 🥺🙏🏻",
    "**Hadir ell Sayang** 😘",
    "**Hadir ell Akuuuuhhh** ☺️",
    "**Hadir ell brother Aku** 🥰",
    "**Sokap bet lu**",
    "**Apasi Bawel** 🥰",
]
...
@register(incoming=True, from_users=DEVS, pattern=r"^pell")
async def naya(naya):
    await naya.reply("**ell gabut**🤩")


@register(incoming=True, from_users=DEVS, pattern=r"^ell")
async def naya(naya):
    await naya.reply("**ell gabut**🤩")
...
async def _(event):
    ...
    uptime = time_formatter((time.time() - start_time) * 1000)
    await x.edit(f"**ᴇʟʟ x ʀᴏʙᴏᴛ !!** `{end}ms`\n**ᴜᴘᴛɪᴍᴇ :** - `{uptime}`")
...
async def _(event):
    ...
    if opt == "heroku":
        ...
        await event.reply("**ᴇʟʟ ʟᴏɢs.**", file=file)
    elif opt == "open":
